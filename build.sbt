...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "Async API bindings for Scala.js",
    version := apiVersion,
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/async.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/async.git</developerConnection>
        <url>github.com/scalajs-io/async.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
